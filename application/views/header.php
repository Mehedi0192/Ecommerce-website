...
<section class="logo-menu-area " data-spy="affix" data-offset-top="197">
    <div class="container">
        <div class="col-md-2 col-sm-2 col-xs-6">
            <div class="row">
               <a href="index.php"><img src="<?php echo base_url() . 'assets/filemanager/' . $contact->logo; ?>"></a> 
            </div>
        </div>
                            ...
                            <a href="" class="dropdown-toggle" data-toggle="dropdown">Product <b class="caret"></b></a>
                                <ul class="dropdown-menu">
                                    <?php foreach ($this->category_model->index() as $row) { ?>
                                        <li><a href="<?php echo base_url() . 'page/category/' . $row->id ?>"><?php echo $row->categoryname; ?></a></li>
                                     <?php } ?>
                                </ul>
                            </li>
                            <li><a href="<?php echo base_url() ?>page/gallery_page">Gallery</a></li>
                            <li><a href="<?php echo base_url() ?>page/contact">Contact</a></li>
                            <li><a href="<?php echo base_url('cart-view')?>">Your Cart</a></li>
                        </ul>
                    </div><!-- /.navbar-collapse -->
                    </nav>
                </div>
