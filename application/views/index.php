            ...
            <div class="row">
                <?php foreach ($article as $key => $row) { ?>
                    <div class="about-cntn">
                        ...
                        <a class="btn about-bttn" href="about.php" target="_blank">Read More <i class="fa fa-angle-double-right"></i> </a>
                    </div>
            ...
            <div class="jcarousel" >
                <ul>
                   <?php foreach ($slider as $key => $row) { ?>
                    <li>
                        <a href="jwle.php"> <img src="<?php echo base_url() . 'assets/filemanager/slider/' . $row->file_name; ?>">
                            <a class="btn btn-product-btn" href="jwle.php"><?php echo $row->title; ?></a>
                            <a href="jwle.php">
                                <div class="middle">
    ...
    <div class="container"><!--Begin:main_section-->
        <div class="row">
            <div class="product-cntn-hdr">
                ...
                <div class="product-cntn-bdr"></div>
                <a class="btn btn-product" href="gallery.php">View More</a>
            </div>
